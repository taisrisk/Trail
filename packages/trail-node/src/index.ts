...
export { indexMailSearch, searchVault } from "./vault/search";
export { createEncryptedBackup, restoreFromEncryptedBackup } from "./vault/backup";
export { processMailWithOllama } from "./watchers/ai";
